...
class DBHandler:
    def __init__(self):
        ...
        self.conn.execute("CREATE TABLE IF NOT EXISTS roznamcha (roznamcha_id INTEGER PRIMARY KEY AUTOINCREMENT, khata_id INTEGER, accounts_id INTEGER, date TEXT,cash_type TEXT, refrences TEXT, description TEXT,cash_in INTEGER DEFAULT 0, cash_out INTEGER DEFAULT 0,remaining INTEGER,accounts_remaining INTEGER DEFAULT 0, created_at TEXT,FOREIGN KEY(khata_id) REFERENCES khata(khata_id),FOREIGN KEY(accounts_id) REFERENCES accounts(accounts_id))")
